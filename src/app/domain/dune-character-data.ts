...
export const DUNE_ALL_CHARACTER_DATA: DuneCharacter[] = [
  // Book 1: Dune
  ...
  {name: 'Leto II Atreides (The Worm)', genders: ['MALE', 'OTHER'], height: 700, hairColors: ['DARK_BROWN', 'NONE'], factions: ['ATREIDES', 'FREMEN', 'BENE_GESSERIT'], books: ['CHILDREN_OF_DUNE', 'DUNE_GOD_EMPEROR']},
